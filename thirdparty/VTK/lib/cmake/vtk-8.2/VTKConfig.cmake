...
set(_vtk_installed_prefix "D:/ProgramFiles/VTK/VTK install/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "D:/ProgramFiles/VTK/VTK install")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/ProgramFiles/VTK/VTK install/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/ProgramFiles/VTK/VTK install/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "D:/ProgramFiles/VTK/VTK-8.2.0/build/bin")
  else ()
    set (VTK_RUNTIME_DIRS "D:/ProgramFiles/VTK/VTK-8.2.0/build/lib")
  endif ()
endif()
