...
set_target_properties(vtkTestingRendering PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkTestingRendering-8.2-gd.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkTestingRendering-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingRendering )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingRendering "${_IMPORT_PREFIX}/lib/vtkTestingRendering-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkTestingRendering-8.2-gd.dll" )
...
set_target_properties(vtkTestingGenericBridge PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkTestingGenericBridge-8.2-gd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkCommonMisc"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkTestingGenericBridge-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingGenericBridge )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingGenericBridge "${_IMPORT_PREFIX}/lib/vtkTestingGenericBridge-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkTestingGenericBridge-8.2-gd.dll" )
...
set_target_properties(vtkGUISupportQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-8.2-gd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkCommonDataModel;vtkFiltersExtraction;vtkInteractionStyle"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkGUISupportQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkGUISupportQt "${_IMPORT_PREFIX}/lib/vtkGUISupportQt-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQt-8.2-gd.dll" )
...
set_target_properties(vtkGUISupportQtOpenGL PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkGUISupportQtOpenGL-8.2-gd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkGUISupportQt;vtkInteractionStyle;Qt5::OpenGL"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkGUISupportQtOpenGL-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkGUISupportQtOpenGL )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkGUISupportQtOpenGL "${_IMPORT_PREFIX}/lib/vtkGUISupportQtOpenGL-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtOpenGL-8.2-gd.dll" )
...
set_target_properties(vtkGUISupportQtSQL PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-8.2-gd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtksys"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkGUISupportQtSQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkGUISupportQtSQL "${_IMPORT_PREFIX}/lib/vtkGUISupportQtSQL-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkGUISupportQtSQL-8.2-gd.dll" )
...
set_target_properties(vtkTestingIOSQL PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkTestingIOSQL-8.2-gd.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_DEBUG "vtkIOSQL"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkTestingIOSQL-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingIOSQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingIOSQL "${_IMPORT_PREFIX}/lib/vtkTestingIOSQL-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkTestingIOSQL-8.2-gd.dll" )
...
set_target_properties(vtkRenderingQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkRenderingQt-8.2-gd.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkRenderingQt-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkRenderingQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkRenderingQt "${_IMPORT_PREFIX}/lib/vtkRenderingQt-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkRenderingQt-8.2-gd.dll" )
...
set_target_properties(vtkViewsQt PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/vtkViewsQt-8.2-gd.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/vtkViewsQt-8.2-gd.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkViewsQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkViewsQt "${_IMPORT_PREFIX}/lib/vtkViewsQt-8.2-gd.lib" "${_IMPORT_PREFIX}/bin/vtkViewsQt-8.2-gd.dll" )
